...
const faqs = [
  ...
  {
    category: "Per Aziende e Attività",
    questions: [
      {
        question: "Come posso iniziare ad accettare Bitcoin nella mia attività?",
        answer: "Ti possiamo aiutare a integrare i pagamenti Bitcoin e Lightning Network nella tua attività. Contattaci a info@bitcointorino.org per una consulenza gratuita e per essere inserito nella directory delle attività Bitcoin-friendly di Torino.",
      },
      {
        question: "Quali sono i vantaggi per un'attività che accetta Bitcoin?",
      ...
      {
        question: "Come posso essere inserito nella directory attività?",
        answer: "Invia una email a info@bitcointorino.org con il nome della tua attività, indirizzo, tipologia di servizi e informazioni su come accetti Bitcoin. Verificheremo i dettagli e ti inseriremo nella nostra mappa delle attività Bitcoin-friendly.",
      },
      {
